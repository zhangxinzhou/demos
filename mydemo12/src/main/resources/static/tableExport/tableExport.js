        ...
        tableExport: function (options) {
            ...
            if (defaults.type == 'csv' || defaults.type == 'txt') {
                ...
                if (defaults.jspdf.autotable === false) {
                    ...
                    // When setting jspdf.format to 'bestfit' tableExport tries
					// to choose
                    // the minimum required paper format and orientation in
					// which the table
                    // (or tables in multitable mode) completely fit without
					// column adjustment
                    ...
                    // thus it can be accessed from any callback function from
					// below
                    ...
                    $(el).filter(':visible').each(function () {
                        if ($(this).css('display') != 'none') {
                            ...
                            // onTable: optional callback function for every
							// matching table that can be used
                            // to modify the tableExport options or to skip the
							// output of a particular table
                            ...
                            // each table works with an own copy of AutoTable
							// options
                            ...
                            // onBeforeAutotable: optional callback function
							// before calling
                            // jsPDF AutoTable that can be used to modify the
							// AutoTable options
                            ...
                            // onAfterAutotable: optional callback function
							// after returning
                            // from jsPDF AutoTable that can be used to modify
							// the AutoTable options
                            if (typeof teOptions.onAfterAutotable === 'function')
                                teOptions.onAfterAutotable($(this), atOptions);


                            // set the start position for the next table (in
							// case there is one)
            ...
            function parseString(cell, rowIndex, colIndex) {
                ...
                if (cell != null) {
                    ...
                    if (defaults.htmlContent === true) {
                        ...
                        result = $cell.text().trim().replace(/\u00AD/g, ""); // remove
																				// soft
																				// hyphens
            ...
            function getPropertyUnitValue(target, prop, unit) {
                ...
                if (numeric !== null) {
                    ...
                    target.parentElement.appendChild(temp); // insert it into
															// the parent for
															// em, ex and %
